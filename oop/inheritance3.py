...
class Student(Person): #kalıtım ile personu aldık.
     def __init__(self,name,surname,age): #yukarıdaki initin değerlerini burda set edicez
        ...
        print("student türetildi") #ekstra bi init yazarsan persondaki initi, ezmiş olursun dikkat bu paratreli init beklmıyor sonr aparametreyide ekle
                                    #parametreleri gönderdikten sonra set etmek lazım.bu sayede bi child sınıf student için şimdi işte ezmeden (ezedebilirr bazı durumlarda dikkat böyle yazcaz bu sınıfa özel)
